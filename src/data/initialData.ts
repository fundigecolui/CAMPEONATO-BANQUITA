import { Team, Player, CardRecord, Match, GoalRecord, TournamentEdition } from '../types';
...
export const INITIAL_PLAYERS: Player[] = [
  // 1. AZUL
  { id: 1, dorsal: 10, name: 'JOSE FIGUEROA', teamId: 'AZUL' },
  { id: 2, dorsal: 1, name: 'ALBERTO OSPINA', teamId: 'AZUL' },
  { id: 3, dorsal: 2, name: 'ANIBAL ROMERO', teamId: 'AZUL' },
  { id: 4, dorsal: 3, name: 'OSCAR PACHECO', teamId: 'AZUL' },
  { id: 5, dorsal: 5, name: 'ALBEIRO BUENDIA', teamId: 'AZUL' },
  { id: 6, dorsal: 6, name: 'LEONARDO CASTILLO', teamId: 'AZUL', isCaptain: true },
  { id: 7, dorsal: 7, name: 'MOISES GOMEZ', teamId: 'AZUL' },
  { id: 8, dorsal: 8, name: 'DOUGLAS CORREA', teamId: 'AZUL' },

  // 2. VERDE
  { id: 9, dorsal: 18, name: 'YAMIR PINEDA', teamId: 'VERDE' },
  { id: 10, dorsal: 8, name: 'CAMILO PACHECO', teamId: 'VERDE', isCaptain: true },
  { id: 11, dorsal: 2, name: 'MARCOS FIGUEROA', teamId: 'VERDE' },
  { id: 12, dorsal: 3, name: 'LUIS PACHECO', teamId: 'VERDE' },
  { id: 13, dorsal: 4, name: 'JAVIER MELENDEZ', teamId: 'VERDE' },
  { id: 14, dorsal: 5, name: 'JAVIER FADUL', teamId: 'VERDE' },
  { id: 15, dorsal: 6, name: 'LUIS SOLANO', teamId: 'VERDE' },
  { id: 16, dorsal: 7, name: 'IVAN ORREGO', teamId: 'VERDE' },

  // 3. NEGRO
  { id: 17, dorsal: 10, name: 'MARIO VELAZCO', teamId: 'NEGRO' },
  { id: 18, dorsal: 1, name: 'RIGOBERTO LOPEZ', teamId: 'NEGRO' },
  { id: 19, dorsal: 2, name: 'JORGE ACEVEDO', teamId: 'NEGRO' },
  { id: 20, dorsal: 3, name: 'NEL MARTIN', teamId: 'NEGRO' },
  { id: 21, dorsal: 4, name: 'RUSBELL VILLALBA', teamId: 'NEGRO', isCaptain: true },
  { id: 22, dorsal: 5, name: 'JHON CUADROS', teamId: 'NEGRO' },
  { id: 23, dorsal: 6, name: 'MANUEL PEÑA', teamId: 'NEGRO' },
  { id: 24, dorsal: 7, name: 'HUGO MERCADO', teamId: 'NEGRO' },

  // 4. NARANJA
  { id: 25, dorsal: 9, name: 'ANDY ACEVEDO', teamId: 'NARANJA' },
  { id: 26, dorsal: 12, name: 'JOSE DAVID HOYOS', teamId: 'NARANJA' },
  { id: 27, dorsal: 2, name: 'CARLOS FIGUEROA', teamId: 'NARANJA', isCaptain: true },
  ...
  { id: 31, dorsal: 7, name: 'EDUAR MONTIEL', teamId: 'NARANJA' },
  { id: 32, dorsal: 8, name: 'JOSE ARROYO', teamId: 'NARANJA' },

  // 5. RAYADO
  { id: 33, dorsal: 10, name: 'RIGOBERTO LOZANO', teamId: 'RAYADO' },
  { id: 34, dorsal: 7, name: 'DIEGO LOPEZ', teamId: 'RAYADO' },
  { id: 35, dorsal: 11, name: 'JORGE LOZANO', teamId: 'RAYADO' },
  { id: 36, dorsal: 8, name: 'DAMIAN MORENO', teamId: 'RAYADO' },
  { id: 37, dorsal: 9, name: 'ALVARO BETIN', teamId: 'RAYADO' },
  { id: 38, dorsal: 39, name: 'WALTER GOEZ', teamId: 'RAYADO' },
  { id: 39, dorsal: 6, name: 'ANUAR OJEDA', teamId: 'RAYADO' },
  { id: 40, dorsal: 20, name: 'JORGE LUIS PINTO', teamId: 'RAYADO' },

  // 6. ROJO
  { id: 41, dorsal: 10, name: 'ALBERT MONTERROZA', teamId: 'ROJO', isCaptain: true },
  { id: 42, dorsal: 9, name: 'ELKIN ACEVEDO', teamId: 'ROJO' },
  { id: 43, dorsal: 1, name: 'JOSE HOYOS', teamId: 'ROJO' },
  { id: 44, dorsal: 2, name: 'MAURICIO DIAZ', teamId: 'ROJO' },
  { id: 45, dorsal: 3, name: 'URIEL ZAMBRANO', teamId: 'ROJO' },
  { id: 46, dorsal: 4, name: 'NILSON CASTILLO', teamId: 'ROJO' },
  { id: 47, dorsal: 5, name: 'ROBERTO PEREZ', teamId: 'ROJO' },
  { id: 48, dorsal: 6, name: 'GUSTAVO FERRER', teamId: 'ROJO' },

  // 7. AMARILLO
  { id: 49, dorsal: 9, name: 'MARIO GUERRA', teamId: 'AMARILLO', isCaptain: true },
  { id: 50, dorsal: 8, name: 'DONALDO MORALES', teamId: 'AMARILLO' },
  { id: 51, dorsal: 10, name: 'ALEJANDRO ESCAMILLA', teamId: 'AMARILLO' },
  { id: 52, dorsal: 5, name: 'EDWIN TEJADA', teamId: 'AMARILLO' },
  { id: 53, dorsal: 11, name: 'PEDRO DE LEON', teamId: 'AMARILLO' },
  { id: 54, dorsal: 7, name: 'JOSE IVAN SIERRA', teamId: 'AMARILLO' },
  { id: 55, dorsal: 17, name: 'HECTOR VERGARA', teamId: 'AMARILLO' },
  { id: 56, dorsal: 4, name: 'BERNARDO GALVIS', teamId: 'AMARILLO' },

  // 8. BLANCO
  { id: 57, dorsal: 10, name: 'ALBERTO OSORIO', teamId: 'BLANCO' },
  { id: 58, dorsal: 1, name: 'DONALDO MARTINEZ', teamId: 'BLANCO' },
  { id: 59, dorsal: 4, name: 'JUAN ALVAREZ', teamId: 'BLANCO' },
  { id: 60, dorsal: 5, name: 'EVER VILLALBA', teamId: 'BLANCO' },
  { id: 61, dorsal: 6, name: 'DAIRO MERCADO', teamId: 'BLANCO' },
  { id: 62, dorsal: 7, name: 'IVAN DIAZ', teamId: 'BLANCO' },
  { id: 63, dorsal: 8, name: 'DANIEL BORJA', teamId: 'BLANCO' },
];
